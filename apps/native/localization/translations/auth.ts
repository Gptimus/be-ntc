export const auth = {
  en: {
    signUp: {
      title: "Get Started",
      description:
        "BE-NTC helps you manage, exchange, and secure your assets with ease and confidence.",
      continueWithApple: "Continue with Apple",
      continueWithGoogle: "Continue with Google",
      continueWithEmail: "Continue with Email",
      terms: {
        agreement: "By continuing, you agree to BE-NTC's ",
        link: "Terms of Use",
      },
    },
    emailInput: {
  ...
  fr: {
    signUp: {
      title: "Commencer",
      description:
        "BE-NTC vous aide à gérer, échanger et sécuriser vos actifs en toute simplicité et confiance.",
